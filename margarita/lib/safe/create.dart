...
class CreatePortal extends StatefulWidget {
  const CreatePortal({super.key});

  @override
  State<CreatePortal> createState() => _CreatePortalState();
}
...
class _CreatePortalState extends State<CreatePortal> {
  ...
  _createPortal(String name, List<String> urls) {
    ...
    Isolate.run(() {
      openPortal(p.identity, token, OpenOptions());
