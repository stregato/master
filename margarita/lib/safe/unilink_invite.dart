...
class _UnilinkInviteState extends State<UnilinkInvite> {
  ...
  reencodeAccess(String access, Identity identity, String id) {
    ...
    return encodeAccess(id, d.safeName, d.creatorId, d.aesKey, d.urls);
  }
  ...
  Widget build(BuildContext context) {
    ...
    var mobileLink = 'https://margarita.zone/a/$_access';
              ...
              if (_access.isEmpty)
                Column(
                  children: [
                    ...
                    ListView(
                      shrinkWrap: true,
                      children: current.communities.entries
                          .map(
                            (e) => Card(
                              child: ListTile(
                                  title: Text(e.key),
