...
func (s *Portal) Put(zoneName, name string, r io.ReadSeeker, options PutOptions) (Header, error) {
...
func deleteFile(portalName, zoneName string, store storage.Store, header Header) error {
