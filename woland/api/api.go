...
func ConnectStart() (int, error) {
	return invite.ConnectStart(Self)
}

func ConnectListen(code int) (ok bool, identity security.Identity, secret int, err error) {
	return invite.ConnectListen(Self, code)
}

func ConnectShare(code int, bobIdentity security.Identity, poolNames []string) error {
	return invite.ConnectShare(Self, code, bobIdentity, poolNames)
}

func ConnectRequest(code int) (secret int, err error) {
	return invite.ConnectRequest(Self, code)
}

func ConnectComplete(code int) (ready bool, tokens []string, err error) {
	return invite.ConnectComplete(Self, code)
}
